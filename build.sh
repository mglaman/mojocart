#!/bin/sh
# Script to build MojoCart 7.x-1.x
...
if [ $SELECTION = "1" ]; then
  ...
  echo "Building MojoCart distribution..."
  DRUSH_OPTS='--no-cache'

elif [ $SELECTION = "2" ]; then

  echo "Building MojoCart distrbution..."
...
ln -s /opt/files/mojocart "$DRUPAL/sites/default/files"
